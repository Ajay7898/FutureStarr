...
@else
<a href="javascript:void(0)" onclick="return getMessage({{ $mess->username.', '.$mess->sent_by }});" class="user_img"  data-username="{{ $mess->username }}" data-sent-id="{{ $mess->sent_by}}" data-turbolinks="false">
@endif
	<div class="chat_list">
