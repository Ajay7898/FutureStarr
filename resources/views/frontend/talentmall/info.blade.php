                                    ...
                                    <div class="portfolio-hover-main">
                                       <div class="portfolio-hover-box">
                                          <div class="portfolio-hover-content position-relative text-left">
                                             ...
                                             <p class="trophy-cust">
                                                <i class="fa fa-trophy {{ $talent->avg_rating >= 1 ? 'gold' : 'grey' }}" aria-hidden="true"></i>
                                                <i class="fa fa-trophy {{ $talent->avg_rating >= 2 ? 'gold' : 'grey' }}" aria-hidden="true"></i>
                                                <i class="fa fa-trophy {{ $talent->avg_rating >= 3 ? 'gold' : 'grey' }}" aria-hidden="true"></i>
                                                <i class="fa fa-trophy {{ $talent->avg_rating >= 4 ? 'gold' : 'grey' }}" aria-hidden="true"></i>
                                                <i class="fa fa-trophy {{ $talent->avg_rating >= 5 ? 'gold' : 'grey' }}" aria-hidden="true"></i>
                                                <span class="cmt-count">({{$talent->talent_comments_count}})</span>
                                             </p>
                                          </div>
                                       </div>
                                    </div>
