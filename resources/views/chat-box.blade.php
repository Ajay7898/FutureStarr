                   ...
                   <!--  <div class="panel-heading">
                    ...
                    <div  class="card-header msg_head">
                            <div class="d-flex bd-highlight">
                                ...
                                <div class="video_cam">
                                    <span><i class="fa fa-video-camera" data-toggle="modal" data-target="#myModal" onclick="inProgress(0);"></i></span>
                                    <span><i class="fa fa-phone" data-toggle="modal" data-target="#myModal" onclick="inProgress(1);"></i></span>
                                </div>
                            </div>
