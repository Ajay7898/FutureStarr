        ...
        fixedContentPos: false
                        ...
                        {!! Form::open(['route' => 'register']) !!}
                           <input type="hidden" name="role_id" value="4">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-lg-12 col-md-12">
                                        <button class="btn btn-danger btn-danger-re btn-lg" type="submit" name="button" style="word-break: break-word;white-space: normal;line-height: 15px;font-size: 9.6px;">Create your FutureStarr Talent account</button>
