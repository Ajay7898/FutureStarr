		...
		<div class="card">
			...
			<div class="card">
				...
				<div class="card-body table-responsive p-0">
					...
					<button  class="btn btn-success sp approve_disapprove_yes_no_choose" type="button"  data-toggle="modal" data-target="#myModal-{{ $talent->id }}">Yes</button> &nbsp; &nbsp;
					@else

                    <button type="button" data-toggle="modal" data-target="#myModal-{{ $talent->id }}" class="btn btn-primary sp approve_disapprove_yes_no_choose"> No</button>
                    @endif
									<!-- Modal -->
								...
								<button  class="btn btn-primary sp approve_disapprove_yes" type="button" data-id="{{ $talent->id }}" data-name="yes"> Yes</button> 
								...
								<button type="button" class="btn btn-primary sp approve_disapprove_no" data-id="{{ $talent->id }}" data-name="No"> No</button>
