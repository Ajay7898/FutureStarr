               ...
               <a style="margin-top: 11px">
                ...
                <li class="{{ Route::currentRouteName() == 'search.index'  ? 'active' : '' }}">
                 <a href="{{ route('search.index')}}" title="Future Starr, Tattoo Artists">
                  <div class="header-icon"><img class="fa-icon-font" src="{{ asset('assets/images/home/starr_s.png') }}" alt="star search icon"></div>
                  STARR SEARCH
                </a>
              </li>
             ...
             <li>
               <a class="dropdown-margin" role="button" data-toggle="dropdown">
                ...
                <div class="header-icon he-ic">
                 ...
                 @else
                 <img class="fa-icon-font" src="{{asset('assets/images/home/starr_s.png')}}" alt="star search icon">
                 @endif
               </div>
               my Account
